...
export default function HealthcareInstituteShareRecords() {
  return (
        ...
        <main className="flex-1 overflow-y-auto p-4">
          ...
          <div className="bg-white rounded-lg shadow mb-6">
            ...
            <table className="w-full">
              ...
              <tbody>
                {[
                  { from: "Your Institute", to: "John Boo", type: "Prescription", subType: "Diabetes", date: "15 Sep, 8:56 AM" },
                  { from: "Dr. Bob Robson", to: "Your Institute", type: "Scan", subType: "Lorem Ipsum", date: "15 Sep, 7:12 AM" },
                  { from: "Hope Health", to: "Your Institute", type: "Doctor's note", subType: "Lorem ipsum", date: "15 Sep, 4:34 AM" },
                  { from: "Your Institute", to: "Jennifer Pinsker", type: "Blood Test", subType: "Lorem ipsum", date: "15 Sep, 2:08 AM" },
                  { from: "Your Institute", to: "Bob Robson", type: "Urine Test", subType: "Lorem ipsum", date: "15 Sep, 8:56 AM" },
                  { from: "Dr. Michael Robinson", to: "Your Institute", type: "Prescription", subType: "Lorem ipsum", date: "15 Sep, 7:12 AM" },
                ].map((record, index) => (
